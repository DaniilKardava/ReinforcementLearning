...
class env_2048:
    ...
    def get_3d_feature(self, data_format="channels_last"):
        
        # Calculate list of binary features and stack indices horizontally. Transpose to align like terms row wise. Reshape
        # Into channel first form and convert into channel last form. 
        feature_vector = self.get_binary_feature()
        feature_vector = feature_vector.reshape(16, 11)
